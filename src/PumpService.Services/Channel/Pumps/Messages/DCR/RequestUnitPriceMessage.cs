...
{
    internal class RequestUnitPriceMessage : IMessage  //CD153
    {
        public RequestUnitPriceMessage(byte _address, byte[] _ProtocolDataUnitData)
        {
        ...
        public byte[] ProtocolDataUnit
        {
            get
            {
                ...
                data[0] = 0x99; // TransactionId Yani Komut Kodu
