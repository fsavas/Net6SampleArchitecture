...
{
    internal class RequestDcrParametersMessage : IMessage  // CD148
    {
        public RequestDcrParametersMessage(byte _address, byte[] _ProtocolDataUnitData)
        {
        ...
        public byte[] ProtocolDataUnit
        {
            get
            {
                ...
                data[0] = 0x89; // TransactionId Yani Komut Kodu
