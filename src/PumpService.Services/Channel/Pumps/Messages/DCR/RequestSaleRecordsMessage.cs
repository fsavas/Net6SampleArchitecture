...
{
    internal class RequestSaleRecordsMessage : IMessage   //CD139
    {
        public RequestSaleRecordsMessage(byte _address, byte[] _ProtocolDataUnitData)
        {
        ...
        public byte[] ProtocolDataUnit
        {
            get
            {
                ...
                data[0] = 0x8B; // TransactionId Yani Komut Kodu
