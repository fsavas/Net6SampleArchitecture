...
{
    internal class UpdateDcrDateTimeMessage : IMessage
    {
        public UpdateDcrDateTimeMessage(byte _address, byte[] _ProtocolDataUnitData)
        {
        ...
        public byte[] ProtocolDataUnit //CD140 implementation
        {
            get
            {
                ...
                data[0] = 0x9B; // TransactionId Yani Komut Kodu
