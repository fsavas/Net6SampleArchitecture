...
{
    internal class RequestNozzleTotalizerMessage : IMessage  //CD135
    {
        public RequestNozzleTotalizerMessage(byte _address, byte[] _ProtocolDataUnitData)
        {
        ...
        public byte[] ProtocolDataUnit
        {
            get
            {
                ...
                data[0] = 0x87; // TransactionId Yani Komut Kodu

                data[1] = (byte)1; // Bu Bytten sonra gelen byte sayısı
