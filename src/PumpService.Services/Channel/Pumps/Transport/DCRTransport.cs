...
{
    public class DCRTransport : SerialTransport
    {
        private PumpSerialDevice device;

        public DCRTransport(IStreamResource streamResource)
            : base(streamResource)
        {
            CheckFrame = true;  // Perform CRC Check for this  Transport
        }

        public void setDevice(PumpSerialDevice device)
        {
            this.device = device;
        }
        ...
        public override void Write(IMessage message)
        {
            ...
            //Log.Logger.Warning("DCR-WrittenTX:" + ByteArrayToString(frame));
        }
        ...
        public override byte[] ReadRequest()
        {
            ...
            //if (frame.Length > 0)
            //    Log.Logger.Warning("DCR-Read-RX:" + ByteArrayToString(frame));
            //else
            //    Log.Logger.Warning("DCR-Read-XX:" + "<NONE>");
